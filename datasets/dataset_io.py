...
class DatasetIO(ABC, metaclass=DatasetMeta):
    """
    ...
    def __getitem__(self, index):
        ...
        if self.data_augmentation_strategy is not None:
            ...
            indicator_map[np.arange(len(untransformed_coords)), 0, untransformed_coords[:, 0].astype(
                int), untransformed_coords[:, 1].astype(int)] = 1
            ...
            transformed_indicator = transformed_indicator[0, :, :, :, :]
