...
# from datasets.dataset_generic import Dataset
...
# # def run_inference_model(trainer, logger, cfg, model_path, model_name, split):
...
# #     temp_results = []
# #     ind_results = []
#     for i, data_dict in enumerate(trainer.eval_dataloader.dataset):
