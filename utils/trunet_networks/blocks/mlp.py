...
from utils.trunet_networks.layers import get_act_layer
...
class MLPBlock(nn.Module):
    ...
    def __init__(
        ...
        self.linear1 = nn.Linear(hidden_size, mlp_dim) if act != "GEGLU" else nn.Linear(
        ...
        if dropout_opt == "vit":
            ...
            raise ValueError(
                f"dropout_mode should be one of {SUPPORTED_DROPOUT_MODE}")
