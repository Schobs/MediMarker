...
class EnsembleUncertainties():
    ...
    def ensemble_inference_with_uncertainties(self, evaluation_logs, tta=False):
        ...
        `evaluation_logs` : dict
            Dictionary of samples of the template from DictLogger.ensemble_inference_log_template()
        `tta` : boolean
            Boolean flag controlling whether tta ensembling is used.
        
        Returns
        -------
        `ensemble_results_dict` : dict
            Dictionary of the ensemble results with the following keys:
        ...
        `ind_errors` : dict
            Dictionary of the individual landmark errors for each uncertainty metric.    
        """
    ...
    def calculate_smha(self, individual_results, ensemble_results_dict, ind_errors, calc_error):
        ...
        `individual_results` : dict
            Dictionary of the individual landmark results of a sample, following the template of 
        ...
        `ensemble_results_dict` : dict
            Dictionary we are saving the uncertainty and coordinate info to per sample.
        `ind_errors` : dict
            Dictionary of the individual landmark errors for each uncertainty metric.
        `calc_error` : boolean
            Whether to calculate the error metrics or not (if the sample has annotation we do).

        Returns
        -------
        `ensemble_results_dict` : dict
            Updated dictionary we are saving the uncertainty and coordinate info to per sample.
        `ind_errors` : dict
            Updated dictionary of the individual landmark errors for each uncertainty metric.
        """
    ...
    def calculate_ecpv(self, individual_results, ensemble_results_dict, ind_errors, target_coords, calc_error, tta=None):
        ...
        `target_coords` : np.array
            The target coordinates of the sample
        `calc_error` : boolean
            Whether to calculate the error metrics or not (if the sample has annotation we do).
