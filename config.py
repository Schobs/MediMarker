...
_C.SAMPLER.PATCH.CENTRED_PATCH_DETERMINISTIC_EVAL = True
...
_C.MODEL.GPFLOW.LIKELIHOOD_NOISE_SEPERATE_OPTIM = False
_C.MODEL.GPFLOW.KL_SCALE = 1.0
...
_C.INFERENCE.LOG_HEATMAPS_WO_NOISE = False
